<template>
    <div>
        <div class="container">
            <h1 class="resume-heading animate__animated animate__fadeInDown">Resu<span>me</span></h1>
            <h2 class="education-heading animate__animated animate__fadeInUp">Educ<span>ation</span></h2>
            <div class="row gap-">
    ...
    <h2 class="skills-heading animate__animated animate__fadeInUp">Ski<span>lls</span></h2>
    <div>
        <div class="container">
            <div class="row gap-3">
...
<script>
  export default {
     computed:{
      ...
      skillsData(){
        return this.$store.state.skillsData
      }
